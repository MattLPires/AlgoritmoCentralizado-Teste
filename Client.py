...
def executa_cliente_a():
    ...
    while True:
        ...
        time.sleep(1)
        resposta_controlador = "1" 
        if tcp_controlador_a.recv(1024).decode:
...
def executa_cliente_b():
    ...
    dest_controlador_b = (HOST, PORT_CONTROLDOR_B)
    ...
    while True:
        ...
        time.sleep(1)
        resposta_controlador = "1" 
        if tcp_controlador_b.recv(1024).decode: 
